...
(function() {
	...
	var geometry = Model.Game.cbBoardGeometryGrid(4,4);
		...
		return {
			...
			pieceTypes: {
				...
				6: {
					...
					value: 5,
					abbrev: 'R',
					initial: [{s:1,p:0},{s:1,p:3},{s:-1,p:12},{s:-1,p:15}],
				},
				...
				8: {
					...
					abbrev: 'K',
					initial: [{s:1,p:2},{s:-1,p:14}],
				},
			},
			
			promote: function(aGame,piece,move) {
				if(piece.t==0 && geometry.R(move.t)==3)
					return [6,7];
...
//# sourceMappingURL=mini4x4-chess-model.js.map
