...
(function() {
	...
	var geometry = Model.Game.cbBoardGeometryGrid(4,8);
		...
		return {
			...
			pieceTypes: {
				...
				3: {
					...
					abbrev: '',
					fenAbbrev: 'P',
					initial: [{s:-1,p:24},{s:-1,p:25},{s:-1,p:26},{s:-1,p:27}],
					epCatch: true,
					epTarget: true,
				},
...
//# sourceMappingURL=demi-chess-model.js.map
