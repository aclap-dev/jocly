...
(function() {
	...
	var geometry = Model.Game.cbBoardGeometryGrid(5,6);
		...
		return {
			...
			promote: function(aGame,piece,move) {
				if(piece.t==1)
					...
					return [2];
				else if(piece.t==0 && geometry.R(move.t)==5)
					return [4,5,6,7];
			...
			castle: {
				...
				"29/25": {k:[28,27],r:[26,27,28],n:"O-O"},
			},
...
//# sourceMappingURL=attack-chess-model.js.map
