...
function MessageListener(event) {
    ...
    if (game) {
        ...
        } else game.listeners.forEach(function (listener) {
    ...
    var promise = new Promise(function (resolve, reject) {
        ...
        if (config) CreateGame(config);else {
            Jocly.listGames().then(function (games) {
                ...
                SystemJS.import("games/" + gameDescr.module + "/" + gameName + "-config.js").then(function (config) {
...
if (typeof WorkerGlobalScope !== 'undefined' && self instanceof WorkerGlobalScope) undefined.GameProxy = {
    createGame: CreateGame
};else exports.createGame = CreateGame;
