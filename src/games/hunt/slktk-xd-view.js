...
View.Game.xdPreInit = function(xdv) {
	...
	this.g.huntGameData.sceneXtras.push({
		id: "dragonfly",
		gadgetData: {
			"3d":{
				type: "meshfile",
				file : fullPath+"/res/xd-view/meshes/slktk/dragonfly.js",
				smooth : 2,
				x: -3600,
				y: -5000,
				rotate: 45,
	...
	this.g.huntGameData.hunterJSFile="/res/xd-view/meshes/slktk/slt.js";
	this.g.huntGameData.preyJSFile="/res/xd-view/meshes/slktk/slt-black.js";
	...
	this.g.huntGameData.fieldMap="/res/xd-view/meshes/slktk/slktk-xd-view.jpg";
